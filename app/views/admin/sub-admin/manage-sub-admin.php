            ...
            <div class="nav_list">
                ...
                <div class="collapse" id="userSubmenu">
                    <ul class="list-unstyled ps-4">
                        <li>
                            <a href="#" class="nav_link active"><i class='bx bx-chevron-right nav_icon'></i> Manage</a>
                        </li>
                        <!-- <li class="">
...
<div class="mt-5 p-5 container-fluid component-container">
    <div class="container mt-2">
        ...
        <div class="d-flex justify-content-end mb-2">
            <a href="botton" class="btn btn-success fw-semibold"><i class='bx bxs-plus-circle fs-5'></i> Add</a>
